...
$firstName_error = $lastName_error = $emailAddress_error = $phoneNumber_error = $password_error = $confirmPassword_error = $gender_error = "";
    ...
    <div class="container">
        ...
        <form class="registration-form" method="post" action="#">
            ...
            <div class="registration-form-item hide studentsInputs">
                ...
                <input type="number" max="3" min="1" id="year">
            </div>
            <div class="registration-form-item hide studentsInputs">
